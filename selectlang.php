...
$lang = $db->query("SELECT * from lang where `open`='yes'")->fetchAll();
...
<html lang="ru">
  ...
  <body>
    ...
    <main>
      <h1>Доступные языковые курсы</h1>
      <div class="langueges">
      ...
      <?php foreach($lang as $lan){  ?>
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <a href="selectlesson.php?new_user_lang=<?php print_r($lan['id']); ?>" class="btn btn-primary">Начать изучать</a>
