...
if(isset($_POST['create'])){
  ...
  $db->query("INSERT INTO `lessons` (`id`, `langid`, `creatorid`, `author`, `name`, `heading`, `Descr`, `video`, `img`, `DateCreate`, `DateChange`, `types`) VALUES (NULL, '$langid', '$id', '$author', '$name', '$heading', '$Descr', '', '$img', '$datetoday', '$datetoday', '$types')");
  ...
  echo("<script>alert('Урок создан!'); location.href = '$way'</script>");
}
  ...
  <body>
    ...
    <main>
      ...
      <form action="" method='post'>
            ...
            <label for="">Заголовок <input require type="text" name="heading" value='' id=""></label> <br>
            <label for="">Описание <textarea require name="Descr" cols='40' rows='5'  id=""></textarea></label> <br>
            <!-- <label for="">Видео(ссылка на ютуб) <input type="text" name="video" value='' id=""></label> <br> -->
            <label for="">Фото <input type="text" name="img" value=''></label> <br>
            <label for="">Тип <input require type="text" name="types" value='' id=""> - (Открыйтый - доступен пользователям, Закрытый/Любой другой - закрыт пользователям)</label> <br>
            <input class="btn btn-primary "  type="submit" name='create' value="Создать урок для этого языка">
      </form>
