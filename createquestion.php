...
if(isset($_POST['create'])){
    ...
    $db->query("INSERT INTO `question` (`id`, `lessonID`, `question`, `answer`) VALUES (NULL, '$lessonid', '$questionn', '$answer')");
    ...
    echo("<script>alert('Вопрос создан!'); location.href = '$way'</script>");
}
  ...
  <body>
    ...
    <main>
      ...
      <form action="" method='post'>
            <label for="">Вопрос <input type="text" name="questionn" value='' id=""></label> <br>
            <label for="">Ответ <input type="text" name="answer" value='' id=""></label> <br>
            <input class="btn btn-primary "  type="submit" name='create' value="Создать вопрос">
      </form>
